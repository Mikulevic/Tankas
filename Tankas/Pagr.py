...
class Tankas():
    ...
    def shoot(self):
        ...
        self.suviai += 1
        if self.kriptys == "i siaure":
            self.suviu_siaure += 1
        if self.kriptys == "i pietus":
            self.suviu_rytai += 1
        if self.kriptys == "i vakarus":
            self.suviu_vakarai += 1
        if self.kriptys == "i rytus":
            self.suviu_rytai += 1
        if self.x_kords and self.y_kords == target.h_kord and target.v_kord:
            print("Pataikei")
            tankas.degalai += 10
